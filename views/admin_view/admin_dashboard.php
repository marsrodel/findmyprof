                  ...
                  elseif (empty($instructors)) { echo '<div class="note">No matches for \"'.htmlspecialchars($q).'\".</div>'; }
                    ...
                    echo '<div style="display:flex;align-items:center;justify-content:space-between;padding:10px;border:1px solid #d9e2db;border-radius:10px;background:#e9f0ea;margin-bottom:8px">'
                          .'<div style="display:flex;gap:10px;align-items:center">'
                            ...
                            .'<div>'
                              .'<div style="font-weight:800">'.htmlspecialchars($u['name']).
                              ' <span style="font-weight:700;color:#0b5b0c;border:1px solid #0b5b0c;border-radius:10px;padding:2px 8px;font-size:12px;background:#eaf7f0">'.
                              htmlspecialchars(strtolower($u['role'])==='executive'?'Executive':'Instructor').
                              '</span>'
                              .'</div>'
