<?php
  ...
  $rows = [];
  $q = mysqli_query($conn, "SELECT id,name,email,department,created_at FROM users WHERE role='Staff' ORDER BY name ASC");
  if ($q) {
  ...
  <div class="layout">
    <aside class="sidebar">
      ...
      <nav class="menu">
        ...
        <a class="item active" href="staff_list.php">STAFF</a>
    ...
    <main class="content">
      <section class="toolbar">
        ...
        <a class="btn add-qr" href="add_personel.php">➕ ADD STAFF</a>
      </section>
      ...
      <section class="panel">
        <div class="table staff-table">
          ...
          <div class="tbody">
            <?php if (empty($rows)) { echo '<div class="empty">No staff found.</div>'; } ?>
