<?php
  ...
  $rows = [];
  $q = mysqli_query($conn, "SELECT id,name,email,department,created_at FROM users WHERE role='Executive' ORDER BY name ASC");
  if ($q) {
...
<head>
  ...
  <title>FindMyProf • Executives</title>
  ...
  <div class="layout">
    <aside class="sidebar">
      ...
      <nav class="menu">
        ...
        <a class="item active" href="executives_list.php">EXECUTIVES</a>
    ...
    <main class="content">
      <section class="toolbar">
        ...
        <a class="btn add-qr" href="add_personel.php">➕ ADD EXECUTIVE</a>
      </section>
      ...
      <section class="panel">
        <div class="table exec-table">
          ...
          <div class="tbody">
            <?php if (empty($rows)) { echo '<div class="empty">No executives found.</div>'; } ?>
